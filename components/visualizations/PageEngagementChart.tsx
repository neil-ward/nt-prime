...
/**
 * PageEngagementChart -- horizontal bar chart of page views, sorted desc.
 *
 * One bar per page path, coloured stone-500. Labels on the left,
 * count on the right.
 */
...
const MARGIN = { top: 8, right: 48, bottom: 24, left: 110 };
const ROW_H = 28;
const BAR_PAD = 4;
...
export default function PageEngagementChart({ data }: Props) {
      ...
      <svg width={width} height={height} className="overflow-visible select-none">
        <g transform={`translate(${MARGIN.left},${MARGIN.top})`}>
          ...
          {sorted.map((d, i) => {
            ...
            const isHov = hovered === d.page;
            return (
              <g
                key={d.page}
                onMouseEnter={() => setHovered(d.page)}
